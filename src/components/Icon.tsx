/**
 * Icon — single inline-SVG component using a sprite of <symbol>s.
 * Mirror of the IC() helper from the Bold Waves canvas.
 */

import { type CSSProperties } from 'react'

export type IconName =
  | 'shield' | 'wallet' | 'chart' | 'fp' | 'lock' | 'mail' | 'bell'
  | 'home' | 'bar' | 'swap' | 'user' | 'search' | 'eye' | 'arrow' | 'arrow-l'
  | 'dl' | 'send' | 'star' | 'trophy' | 'zap' | 'clock' | 'copy' | 'share'
  | 'card' | 'grid' | 'layers' | 'key' | 'plus' | 'settings' | 'refresh'
  | 'cloud-off' | 'target' | 'check' | 'x' | 'dollar' | 'mic' | 'msg'
  | 'phone' | 'globe' | 'doc' | 'pause' | 'play' | 'volume' | 'camera'
...
export function Icon({ name, size = 18, color, className, style }: Props) {
  const finalStyle: CSSProperties = { ...style }
  if (color) finalStyle.stroke = color
  return (
    <svg
      width={size}
      height={size}
...
/**
 * IconSprite — render once at the app root. <Icon> references symbols here.
 */
export function IconSprite() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" style={{ display: 'none' }}>
      ...
      <symbol id="i-wallet" viewBox="0 0 24 24"><path d="M21 12V7H5a2 2 0 0 1 0-4h14v4"/><path d="M3 5v14a2 2 0 0 0 2 2h16v-5"/><path d="M18 12a2 2 0 0 0 0 4h4v-4h-4z"/></symbol>
      <symbol id="i-chart" viewBox="0 0 24 24"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></symbol>
      <symbol id="i-fp" viewBox="0 0 24 24"><path d="M2 12C2 6.5 6.5 2 12 2a10 10 0 0 1 8 4"/><path d="M5 19.5C5.5 18 6 15 6 12c0-3.5 2.5-6 6-6"/><path d="M12 10c-1.1 0-2 .9-2 2 0 2 1 4 1 6"/><path d="M15 13.5c0-1.5-1-3.5-3-3.5"/><path d="M17.5 12c0-3-2.5-6-5.5-6"/><path d="M22 16c-1 3-3 5.5-6 7"/></symbol>
      ...
      <symbol id="i-arrow-l" viewBox="0 0 24 24"><line x1="19" y1="12" x2="5" y2="12"/><polyline points="12 19 5 12 12 5"/></symbol>
      ...
      <symbol id="i-star" viewBox="0 0 24 24"><polygon points="12 2 15 9 22 9 17 14 18 21 12 17 6 21 8 14 2 9 9 9"/></symbol>
      <symbol id="i-trophy" viewBox="0 0 24 24"><path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6"/><path d="M18 9h1.5a2.5 2.5 0 0 0 0-5H18"/><path d="M4 22h16"/><path d="M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20 7 22"/><path d="M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20 17 22"/><path d="M18 2H6v7a6 6 0 0 0 12 0V2Z"/></symbol>
      ...
      <symbol id="i-settings" viewBox="0 0 24 24"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-2.82 1.18V21a2 2 0 1 1-4 0v-.09a1.65 1.65 0 0 0-1.08-1.51 1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 3.68 15 1.65 1.65 0 0 0 2.17 14H2.09A2 2 0 1 1 2 10h.09a1.65 1.65 0 0 0 1.51-1.08 1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 1 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9c.26.6.81 1.01 1.44 1.08H21a2 2 0 1 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"/></symbol>
      ...
      <symbol id="i-gift" viewBox="0 0 24 24"><polyline points="20 12 20 22 4 22 4 12"/><rect x="2" y="7" width="20" height="5"/><line x1="12" y1="22" x2="12" y2="7"/><path d="M12 7H7.5a2.5 2.5 0 0 1 0-5C11 2 12 7 12 7zM12 7h4.5a2.5 2.5 0 0 0 0-5C13 2 12 7 12 7z"/></symbol>
      <symbol id="i-pin" viewBox="0 0 24 24"><line x1="12" y1="17" x2="12" y2="22"/><path d="M5 17h14v-1.76a2 2 0 0 0-1.11-1.79L15 12V8h1a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1H8a1 1 0 0 0-1 1v4a1 1 0 0 0 1 1h1v4l-2.89 1.45A2 2 0 0 0 5 15.24z"/></symbol>
      ...
      <symbol id="i-thumbs-up" viewBox="0 0 24 24"><path d="M14 9V5a3 3 0 0 0-3-3l-4 9v11h11.28a2 2 0 0 0 2-1.7l1.38-9A2 2 0 0 0 19.66 9H14zM2 9h4v12H2z"/></symbol>
      ...
      <symbol id="i-handshake" viewBox="0 0 24 24"><path d="M12 22h-2a2 2 0 0 1-2-2v-2.5L4 14l3-3 3 3 2-2 4 4-3 3v2.5a2 2 0 0 1-2 2"/><path d="M14 4l3 3-3 3"/><path d="M3 11l4-4 3 3"/></symbol>
      ...
      <symbol id="i-more" viewBox="0 0 24 24"><circle cx="6" cy="12" r="1.5"/><circle cx="12" cy="12" r="1.5"/><circle cx="18" cy="12" r="1.5"/></symbol>
      ...
      <symbol id="i-piggy" viewBox="0 0 24 24"><path d="M19 5c-1.5 0-2.8 1.4-3 2-3.5-1.5-11-.3-11 5 0 1.8 0 3 2 4.5V20h4v-2h3v2h4v-4c1-.5 1.7-1 2-2h2v-4h-2c0-1-.5-1.5-1-2h0V5z"/><path d="M2 9v1c0 1.1.9 2 2 2h1"/><path d="M16 11h0"/></symbol>
      <symbol id="i-cards" viewBox="0 0 24 24"><rect x="3" y="3" width="13" height="13" rx="2"/><path d="M21 7v12a2 2 0 0 1-2 2H7"/></symbol>
